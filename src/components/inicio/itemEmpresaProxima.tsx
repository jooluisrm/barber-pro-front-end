...
export const ItemEmpresaProxima = () => {
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex gap-1 items-center text-sm"><span><MapPin className="text-red-500" size={20} /></span>22.73km</div>
                    </div>
                </div>
            </div>
