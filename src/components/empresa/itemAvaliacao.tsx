        ...
        <div className="flex items-center justify-between gap-5 border-b pb-10 pt-5">
            <div className="flex items-center gap-5">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 max-w-[180px] max-h-[50px] md:max-w-[550px] h-full overflow-hidden">{data.comentario}</p>
                </div>
            </div>
                    ...
                    <div className="flex">
                        {
                            new Array(data.nota).fill(null).map((_, index) => (
                                <StarIcon size={15} isFilled={true} key={index} />
                            ))
                        }
                    </div>
                </div>
